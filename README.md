...
This program performs basic network reconnaissance inside a terminal. It takes a host and a range 
of TCP ports and determines which ports are open/listening. The tool utilizes concurrent scans to 
speed up operations on large ranges. 
...
#### Enter host and port ranges, and scan
...
- Large remote scans may take a very long time to complete, even with concurrent scans
  - Ex: scan from ports 0 to 10000 on hostname 'google.com' took 100.540 seconds
